package com.revolo.lock.shulan.utils;
...
import com.revolo.lock.shulan.pro_sp.PreferenceUtil;
...
//        put(key, value, false);
    ...
    public int getInt(@NonNull final String key) {
        return getI(key, R.mipmap.ic_launcher);
    }
    ...
    public static void init(Context context) {
        if (mPreferences == null)
            mPreferences = PreferenceUtil.getSharedPreference(context, "KAADAS_SHULAN_DEV");
    }
