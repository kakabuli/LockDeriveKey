package com.revolo.lock.shulan.config;
...
public class KeepAliveConfig {
    ...
    public static String REVOLO_ACTION_SCRREN_OFF = "REVOLO_ACTION_SCRREN_OFF";
    public static String REVOLO_ACTION_SCRREN_ON = "REVOLO_ACTION_SCRREN_ON";
    ...
    public static String SP_NAME = "revoloKeepAliveConfig";
