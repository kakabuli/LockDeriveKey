package com.revolo.lock.shulan.receive;
...
import com.revolo.lock.shulan.onepx.OnePixelActivity;
...
public final class OnepxReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {    //屏幕关闭的时候接受到广播
            ...
            //通知屏幕已关闭，开始播放无声音乐
            context.sendBroadcast(new Intent(KeepAliveConfig.REVOLO_ACTION_SCRREN_OFF));
            ...
            //通知屏幕已点亮，停止播放无声音乐
            context.sendBroadcast(new Intent(KeepAliveConfig.REVOLO_ACTION_SCRREN_ON));
        }
    }
