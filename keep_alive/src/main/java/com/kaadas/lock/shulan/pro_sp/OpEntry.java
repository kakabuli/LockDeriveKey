...
class OpEntry {
    ...
    static final String KEY_KEY = "key_shulan_key";

    static final String KEY_VALUE = "key_shulan_value";


    static final String KEY_VALUE_TYPE = "key_shulan_value_type";

    static final String KEY_OP_TYPE = "key_shulan_op_type";
