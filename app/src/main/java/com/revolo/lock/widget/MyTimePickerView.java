...
public class MyTimePickerView extends TimePickerView {
    ...
    private TextView yearLabel, monthLabel, dayLabel, hourLabel, minutesLabel, secondLabel;
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.dialog_picker_view_time, contentContainer);
        ...
        if (mPickerOptions.type.length == 6) {
            yearLabel.setVisibility(mPickerOptions.type[0] ? View.VISIBLE : View.GONE);
            monthLabel.setVisibility(mPickerOptions.type[1] ? View.VISIBLE : View.GONE);
            dayLabel.setVisibility(mPickerOptions.type[2] ? View.VISIBLE : View.GONE);
            hourLabel.setVisibility(mPickerOptions.type[3] ? View.VISIBLE : View.GONE);
            minutesLabel.setVisibility(mPickerOptions.type[4] ? View.VISIBLE : View.GONE);
            secondLabel.setVisibility(mPickerOptions.type[5] ? View.VISIBLE : View.GONE);
        }
