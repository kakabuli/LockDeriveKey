...
public class LockIndicator extends View {
	...
	public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
		...
		patternNoraml = ContextCompat.getDrawable(getContext(), R.drawable.gray_small_round);
		patternPressed = ContextCompat.getDrawable(getContext(), R.drawable.green_small_round);
		if (patternPressed != null) {
			patternWidth = patternPressed.getIntrinsicWidth();
			patternHeight = patternPressed.getIntrinsicHeight();
			this.f = (patternWidth );
			this.g = (patternHeight);
