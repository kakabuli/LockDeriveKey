...
public class RecordState {
    ...
    @IntDef(value = {SOMEONE_USE_A_PWD_TO_UNLOCK, SOMEONE_USE_GEO_FENCE_TO_UNLOCK,
            ...
            THE_USER_REMOVED_SOMEONE_FROM_FAMILY_GROUP, USER_ADDED_SOMEONE_AS_GUEST_USER, USER_REMOVED_SOMEONE_FROM_GUEST_USER})
