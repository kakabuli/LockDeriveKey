    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.radio_button_249) {
                HttpRequest.HOST = HttpRequest.LOCAL_HOST_249;
                ...
                HttpRequest.HOST = HttpRequest.LOCAL_HOST_248;
                ...
                HttpRequest.HOST = HttpRequest.LOCAL_HOST_ALPHA;
                ...
                HttpRequest.HOST = HttpRequest.LOCAL_HOST_ABROAD;
