...
public class LockEasyPermissions{
    ...
    public static void requestPermissions(
        ...
        requestPermissions(
                new PermissionRequest.Builder(host, requestCode, perms)
                        ...
                        .setTheme(R.style.pwdhintStyle)
                        .build());
    }
    private final static int theme1=3;
     ...
     * callbacks through {@link EasyPermissions.PermissionCallbacks} and methods annotated with {@link
     ...
     *                     AfterPermissionGranted} or implement {@link EasyPermissions.PermissionCallbacks}.
     */
     ...
     *                          EasyPermissions.PermissionCallbacks#onPermissionsDenied(int, List)}
