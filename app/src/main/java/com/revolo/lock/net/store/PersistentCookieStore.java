package com.revolo.lock.net.store;
...
public class PersistentCookieStore implements CookieStore {
    ...
    protected String encodeCookie(SerializableHttpCookie cookie)
    {
        ...
        {
            Timber.e("IOException in encodeCookie %1s", e.getMessage());
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString)
    {
        ...
        {
            Timber.e("IOException in decodeCookie %1s", e.getMessage());
        } catch (ClassNotFoundException e)
        {
            Timber.e("ClassNotFoundException in decodeCookie %1s", e.getMessage());
        }
