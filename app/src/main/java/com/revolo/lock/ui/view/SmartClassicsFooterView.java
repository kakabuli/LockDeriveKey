...
public class SmartClassicsFooterView extends ClassicsAbstract<ClassicsFooter> implements RefreshFooter {
    ...
    public SmartClassicsFooterView(Context context) {
        this(context, null);
    }

    public SmartClassicsFooterView(Context context, AttributeSet attrs) {
        super(context, attrs, 0);

        View.inflate(context, R.layout.smart_lock_srl_classics_footer, this);
