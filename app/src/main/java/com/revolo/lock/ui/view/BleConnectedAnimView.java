...
public class BleConnectedAnimView extends View {
    private Paint centerPaint, spreadPaint;
    private int maxRadius, radius, distance;
    private List<Integer> spreadRadius = new ArrayList<>();
    private List<Integer> alphas = new ArrayList<>();
    private float centerX;//圆心x
    private float centerY;//圆心y
    private int delayMilliseconds = 50;//扩散延迟间隔，越大扩散越慢

    public BleConnectedAnimView(Context context) {
        this(context, null, 0);
    }

    public BleConnectedAnimView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BleConnectedAnimView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
