...
public class ModifyPasswordActivity extends BaseActivity {
    ...
    public void onDebouncingClick(@NonNull View view) {
        if (view.getId() == R.id.ivEye) {
            mIvEye.setImageResource(isShowPwd ? R.drawable.ic_login_icon_display_white : R.drawable.ic_login_icon_hide_white);
        ...
        if (view.getId() == R.id.ivOldPwdEye) {
            mIvOldPwdEye.setImageResource(isShowOldPwd ? R.drawable.ic_login_icon_display_white : R.drawable.ic_login_icon_hide_white);
